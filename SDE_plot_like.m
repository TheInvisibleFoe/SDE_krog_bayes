...
output = importdata('samples/largenoisetrack_output.mat');
...
track = importdata('samples/largenoisetrack.mat');
...
plot(f,like)
line([-0.3 -0.3],[0 1],'Color',[0 0.6 0],'Linewidth',1,'LineStyle','--'); 
...
text(0.25,2.6,'Likelihood','Interpreter','latex','FontSize',l_size+2)
