...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Calculates percentiles, maximum likelihood parameters, mean and standard deviation for the parameters
% in samples. If model.add contains function of the parameters, then
